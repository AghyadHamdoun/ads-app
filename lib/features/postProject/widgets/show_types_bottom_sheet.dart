...
Future<String?> showTypesBottomSheet({
              ...
              return Container(
                ...
                child: Column(
                  children: [
                    ...
                    state.typesAndObjectivesModel!.message!.type!.isNotEmpty?
                      ListView.separated(
                          ...
                          itemBuilder: (context, index) {
                            return  Padding(
                                ...
                                child: InkWell(
                                  onTap: (){
                                    bloc.add(ChangeTypeEvent(
                                        state.typesAndObjectivesModel!.message!.type![index]));
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      Expanded(
                                        child: Text(
                                          state.typesAndObjectivesModel!.message!.type![index].name??'',
                                          style: TextStyle(
                                              fontSize: 15.sp,
                                              fontFamily: 'Roboto',
                                              fontWeight: FontWeight.w600,
                      ...
                      }, itemCount: state.typesAndObjectivesModel!.message!.type!.length):
