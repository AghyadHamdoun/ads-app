...
class AllAdsModel {
  ...
  AllAdsModel({this.type, this.message});
...
class Message {
  ...
  Message.fromJson(Map<String, dynamic> json) {
    ...
    objective =
    json['objective'] != null ? TypeModel.fromJson(json['objective']) : null;
    if (json['bids'] != null) {
      bids = <Bids>[];
      json['bids'].forEach((v) {
    ...
    requestedUser = json['requested_user'] != null
        ? RequestedUser.fromJson(json['requested_user'])
        : null;
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (requestedUser != null) {
      data['requested_user'] = requestedUser!.toJson();
    }
    return data;
  }
}
...
class Bids {
  ...
  Bids.fromJson(Map<String, dynamic> json) {
    ...
    proposalBy = json['proposal_by'] != null
        ? PostedBy.fromJson(json['proposal_by'])
        : null;
    amount = json['amount'];
